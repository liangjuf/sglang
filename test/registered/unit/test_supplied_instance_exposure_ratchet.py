            ...
            for fn in ast.walk(tree):
                ...
                for node in ast.walk(fn):
                    if (
                        ...
                        # `getattr(server_args, "field", default)` is the same
                        # read in optional clothing; only a literal name can be
                        # censused (a computed one stays invisible, like every
                        # other census in this family).
